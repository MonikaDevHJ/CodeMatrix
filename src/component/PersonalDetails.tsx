      ...
      <div className="bg-purple-600 text-white px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">Personal details</h1>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="text-center mb-6">
                ...
                <button className="text-sm text-gray-600 hover:text-gray-800">Upload Photo</button>
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <form className="space-y-6">
                ...
                {/* Bio Description */}
                <div>
                  <label htmlFor="bioDescription" className="block text-sm font-medium text-gray-700 mb-2">
                    Bio Description
                  </label>
                  <textarea
                    id="bioDescription"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    />
                    <p className="text-xs text-gray-500 mt-1">Will use this email id to send you confirmation.</p>
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    />
                    <p className="text-xs text-gray-500 mt-1">Will use this number if they need to contact you.</p>
                  </div>
                </div>
